...
export var deleteJob = createAsyncThunk('job/deleteJob', deleteJobThunk)

export var createJob = createAsyncThunk('job/createJob', createJobThunk)

export var modifyJob = createAsyncThunk('job/modifyJob', modifyJobThunk)
